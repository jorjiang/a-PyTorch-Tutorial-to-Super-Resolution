...
test_freq = 200  # print test results once every __ batches
...
def main():
    ...
    for epoch in range(start_epoch, epochs):
        ...
        # if ((epoch % 2 == 0) and (epoch != 0)) or (epoch in {0, 1, 2}):
    ...
    for i, (lr_imgs, hr_imgs) in enumerate(train_loader):
        ...
        if i % test_freq == 0:
            try:
                ...
                file_name = '{}_{}_{}.png'.format(str(epoch).zfill(4), str(i).zfill(6), now)
